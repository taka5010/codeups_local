...
<div class="sub-mv">
  <picture>
    <source srcset="<?php echo esc_url(get_theme_file_uri()); ?>/assets/images/common/mv-info-sp.jpg"
      media="(max-width: 769px)" />
    <img src="<?php echo esc_url(get_theme_file_uri()); ?>/assets/images/common/mv-info-pc.jpg" alt="">
  </picture>
  ...
  <div class="sub-information__inner inner">
    <div class="sub-information__menu">
      <div class="sub-information__items">
        <div class="sub-information__item sub-information__item-1 js-tab-switch is-active" data-tab="tab-1">
          <span>ライセンス<br>情報</span>
        </div>
      ...
      <div class="sub-information__contents">
        <div id="info1" class="sub-information__content js-tab-cts is-active" data-tab="tab-1">
          ...
          <div class="sub-information__img">
            <picture>
              <source srcset="<?php echo esc_url(get_theme_file_uri()); ?>/assets/images/common/info_menu1-sp.jpg"
                media="(max-width: 769px)" alt="ダイバーたちの画像" />
              <img src="<?php echo esc_url(get_theme_file_uri()); ?>/assets/images/common/info_menu1-pc.jpg"
                alt="サンゴの画像">
            </picture>
          </div>
        </div>
        <div id="info2" class="sub-information__content js-tab-cts" data-tab="tab-2">
          ...
          <div class="sub-information__img">
            <picture>
              <source srcset="<?php echo esc_url(get_theme_file_uri()); ?>/assets/images/common/info_menu2-sp.jpg"
                media="(max-width: 769px)" alt="魚群の画像" />
              <img src="<?php echo esc_url(get_theme_file_uri()); ?>/assets/images/common/info_menu2-pc.jpg"
                alt="サンゴの画像">
            </picture>
          </div>
        </div>
        <div id="info3" class="sub-information__content js-tab-cts" data-tab="tab-3">
          ...
          <div class="sub-information__img">
            <picture>
              <source srcset="<?php echo esc_url(get_theme_file_uri()); ?>/assets/images/common/info_menu3-sp.jpg"
                media="(max-width: 769px)" alt="魚の画像" />
              <img src="<?php echo esc_url(get_theme_file_uri()); ?>/assets/images/common/info_menu3-pc.jpg"
                alt="サンゴの画像">
            </picture>
          </div>
        </div>
